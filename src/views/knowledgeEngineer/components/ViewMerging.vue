  ...
  <div>
    ...
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        <span>Merging</span>
        <el-button style="float: right; padding: 3px 0" type="text" @click="showTable">Inspect SameAs Rels</el-button>
      </div>

      <div id="MergingView" :style="{width: '100%', height: '500px', float: 'left'}" />

      <div>
        <SameAsDetailTable v-if = "tableVisible"/>
      </div>
...
import SameAsDetailTable from './SameAsDetailTable'
...
export default {
  ...
  methods: {
    ...
    initChart() {
      const chart = echarts.init(document.getElementById('MergingView'), 'macarons')
      chart.setOption({
        toolbox: {
          show: true,
          feature: {
